...
class Game:
    def __init__(self, ALTO, ANCHO):
        ...
        self.fondo_inicio = pygame.image.load(
            "./assets/imagen/fondo/estrellas_inicioo.jpg").convert()
        self.fondo_inicio = pygame.transform.scale(
            self.fondo_inicio, (ALTO, ANCHO))
        self.fondo_pausa = pygame.image.load("./assets/imagen/fondo/pausa_fondo.png").convert()
        ...
        self.capi_ganar = Objeto(
            (350, 350), (ANCHO//2+55, 500), "./assets/imagen/personaje/capi_ganar.png")
        self.capi_perder = Objeto(
            (400, 350), (ANCHO//2+200, 500), "./assets/imagen/personaje/capi_perder.jpg")

        self.portal = Objeto((60, 100), (ANCHO-35, ALTO - 102),
                             "./assets/imagen/fondo/tercer_portal.png")
