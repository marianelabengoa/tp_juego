class nivel_2:
    def __init__(self, pantalla, ALTO, ANCHO, FPS, size_capybara, score, plataforma_size):
        ...
        fondo2 = pygame.image.load(
            "./assets/imagen/fondo/copia4.png").convert_alpha()
        fondo2 = pygame.transform.scale(fondo2, pantalla)

        contador_vidas = 3

        suelo = pygame.surface.Surface((ANCHO, 100))
        suelo.fill(AZUL)
        rect_suelo = suelo.get_rect()
        rect_suelo.bottom = ALTO
        ...
        plat = Objeto(plataforma_size, (200, ALTO - 102),
                      "./assets/imagen/fondo/ladrillo.png")
        plat2 = Objeto(plataforma_size, (275, ALTO - 172),
                       "./assets/imagen/fondo/ladrillo.png")
        plat3 = Objeto(plataforma_size, (345, ALTO - 240),
                       "./assets/imagen/fondo/ladrillo.png")
        plat4 = Objeto(plataforma_size, (605, ALTO - 102),
                       "./assets/imagen/fondo/ladrillo.png")

        portal = Portal((60, 120), (ANCHO-35, ALTO - 92))

        corazon = Corazon((70, 20), (ANCHO-70, 60),
                          contador_vidas)
        
        coin = Objeto((20,20), (200, ALTO - 172), "./assets/imagen/coin/coin.png")
        coin2 = Objeto((20,20), (800, ALTO - 112), "./assets/imagen/coin/coin.png")
        ...
        capi = Personaje(size_capybara, (0, ALTO - 110),
                         capi_no_volteado, capi_volteado)
        ...
        enemy = Enemi(size_capybara, (800, ALTO - 102),
                      enemigo_no_volteado, enemigo_volteado)
        enemy2 = Enemi(size_capybara, (400, ALTO - 102),
                       enemigo_no_volteado, enemigo_volteado)
        ...
        imagen_piso = pygame.image.load(
            "./assets/imagen/fondo/99.png").convert()
        tamaño_cuadrado = 100
        imagen_piso = pygame.transform.scale(
            imagen_piso, (tamaño_cuadrado, tamaño_cuadrado))
        superficie_piso = pygame.Surface((ANCHO, tamaño_cuadrado))
        ...
        while True:
            ...
            enemy_v.disparar(7, sprites, lasers_enemigos,
                             "./assets/imagen/personaje/660.png", segundos)
            ...
            for laser_enemigo in lasers_enemigos:
                if pygame.sprite.spritecollide(laser_enemigo, lasers, True):
                    lasers_enemigos.remove(laser_enemigo)

            
            if pygame.sprite.spritecollide(enemy2, lasers, True):
                score+=500
            ...
            enemy.update(plat4.rect)
            enemy2.update(plat.rect)
            enemy2.update(plat4.rect)
            ...
            display.blit(suelo, rect_suelo)
            plataformas.draw(display)
            corazones.draw(display)
            coins.draw(display)

            for x in range(0, ANCHO, tamaño_cuadrado):
                superficie_piso.blit(imagen_piso, (x, 0))

            display.blit(superficie_piso, (0, ALTO - tamaño_cuadrado))
