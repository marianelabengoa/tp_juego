...
class nivel_3:
    def __init__(self, pantalla, ALTO, ANCHO, FPS, size_capybara, plataforma_size, JUEGO):
        ...
        self.plat = Objeto(plataforma_size, (500, ALTO - 102),
                           "src/assets/imagen/fondo/ladrillo.png")
        self.plat2 = Objeto(plataforma_size, (575, ALTO - 172),
                            "src/assets/imagen/fondo/ladrillo.png")
        self.plat3 = Objeto(plataforma_size, (645, ALTO - 240),
                            "src/assets/imagen/fondo/ladrillo.png")
        self.plat4 = Objeto(plataforma_size, (200, 350),
                            "src/assets/imagen/fondo/ladrillo.png")
        ...
        self.enemy2 = Enemi(size_capybara, (300, ALTO - 102),
                            self.enemigo_no_volteado, self.enemigo_volteado)

        self.volador = "src/assets/imagen/personaje/volador.png"
        self.enemy_v = Enemi((50, 70), (800, ALTO - 300),
                             self.volador, self.volador)
        self.enemy_v2 = Enemi((50, 70), (500, ALTO - 300),
                              self.volador, self.volador)

        self.coin = Objeto((20, 20), (645, ALTO - 400),
                           "src/assets/imagen/coin/coin.png")
        self.coin2 = Objeto((20, 20), (200, ALTO - 150),
                            "src/assets/imagen/coin/coin.png")
        self.vida_extra = Objeto(
            (20, 20), (800, ALTO - 112), "src/assets/imagen/coin/cora.png")
        ...
        self.enemigos.add(self.enemy_v2)
        ...
        while True:
            ...
            self.enemy_v2.disparar(7, self.sprites, self.lasers_enemigos,
                                   "src/assets/imagen/personaje/660.png", self.segundos)
            ...
            self.enemy_v2.update(self.plat3.rect)
            self.lasers.update()
